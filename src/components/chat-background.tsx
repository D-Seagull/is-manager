...
// Fixed wallpaper behind the messages (doesn't scroll). `trip` uses the chat2
// art (a bright photo) shown whole (contain); DM + group chats use the original
// chat-bg as a subtle dimmed cover.
